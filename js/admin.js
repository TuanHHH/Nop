...
function addTableKhachHang() {
    ...
    for (var i = 0; i < listUser.length; i++) {
        ...
        s += `<tr>
            <td style="width: 5%">` + (i+1) + `</td>
            <td style="width: 16px; word-break: break-word;" >` + u.ho + ' ' + u.ten + `</td>
            <td style="width: 45px; word-break: break-word;">` + u.email + `</td>
            <td style="width: 40px; word-break: break-word;">` + u.username + `</td>
            <td style="width: 20px; word-break: break-word;">` + u.cccd + `</td>
            <td style="width: 26px; word-break: break-word;">` + u.pass + `</td>
            <td style="width: 42px; word-break: break-word;">` + u.address + `</td>
            <td style="width: 20px; word-break: break-word;">` + u.phone + `</td>
            <td style="width: 5%">
                <div class="tooltip">
                    <label class="switch">
